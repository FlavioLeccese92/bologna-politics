...
tags$h6(style = "margin-left: 40px; margin-bottom: 0px;",
        ...
        tags$a(href = "https://opendata.comune.bologna.it/explore/dataset/elezioni-amministrative-2021-sezioni-elettorali/information/",
                      "link"), ")")
tags$h6(style = "margin-left: 40px; margin-top: 0px;",
...
Un altro aspetto da tenere in considerazione è la differente nomenclatura con cui la stessa
lista si può presentare in diverse tornate elettorali. Per agevolare la riconciliazione è 
stata creata la tabella `liste_riconciliate`, di seguito un estratto:

```{r esempio-liste_riconciliate, echo=FALSE}
readRDS(paste0(pl, "data/general-porpuse/liste_conciliate.rds"))
```
