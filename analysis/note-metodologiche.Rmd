...
readRDS(paste0(pl, "data/general-porpuse/nome_lista_conciliazione.rds")) %>% 
  reactable(.,
            ...
            columns = list(
              key = colDef(sticky = "left"),
              organo = colDef(sticky = "left", aggregate = "unique"),
              nome_lista_opendata = colDef(width = 250),
              nome_lista_eligendo = colDef(width = 250),
              nome_coalizione_eligendo = colDef(width = 250)
            ),
  class = "politics-class",
...
readRDS(paste0(pl, "data/general-porpuse/contrassegni.rds")) %>% 
  ...
  reactable(.,
            height = 350, pagination = FALSE,
            fullWidth = FALSE, striped = FALSE, width = "100%", borderless = TRUE, bordered = TRUE,
            groupBy = c("nome_lista_eligendo"),
            columns = list(
              nome_lista_eligendo = colDef(width = 300, sticky = "left"),
              image = colDef(
                width = 100,
                style = background_img(height = "50px", width = "50px", position = "center")),
              key = colDef(),
              organo = colDef()
            ),
